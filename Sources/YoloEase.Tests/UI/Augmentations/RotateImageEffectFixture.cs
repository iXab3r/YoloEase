...
/// <summary>
/// Covers bounding-box remapping performed by the rotate augmentation.
/// </summary>
public class RotateImageEffectFixture
{
    /// <summary>
    /// WHAT: Verifies that rotation keeps annotation rectangles aligned with their transformed image pixels.
    /// HOW: Exercises 90, 180, 270, and no-op rotations across square, landscape, and portrait images.
    /// </summary>
    [Test]
