...
/// <summary>
/// Covers bounding-box remapping performed by the flip augmentation.
/// </summary>
public class FlipImageEffectFixture
{
    /// <summary>
    /// WHAT: Verifies that a flip operation moves annotation rectangles into the same coordinates as the transformed image.
    /// HOW: Applies representative horizontal, vertical, and no-op flips across square, landscape, and portrait images.
    /// </summary>
    [Test]
