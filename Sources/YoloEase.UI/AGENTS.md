...
- Dispose Blazor/WebView/JS interop objects with `DisposeJsSafeAsync` or `DisposeJsSafe` instead of direct `DisposeAsync`/`Dispose`, especially during window and view teardown.
